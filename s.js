...
/**
     ...
     */
    function handleSend() {
        if (modelDropdown.value === 'flux-realism' || modelDropdown.value === 'flux' || modelDropdown.value === 'flux-anime' || modelDropdown.value === 'flux-3d'  || modelDropdown.value === 'flux-disney' || modelDropdown.value === 'flux-pixel' || modelDropdown.value === 'flux-4o' || modelDropdown.value === 'any-dark') {
    ...
    function parseMessage(textSpan, message, user = true, messageDiv) {
        ...
        } else if (message.startsWith("https://api.airforce/imagine2?model=")) {
